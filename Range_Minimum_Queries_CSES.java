...
public class  Range_Minimum_Queries_CSES{
    ...
    static class SegmentTree{
        ...
        public long getMin(int i, int s, int e, int l , int r){
            if(e < l || s > r){
                ...
                long li = getMin(2*i+1, s, mid,l,r);
                long ri = getMin(2*i+2,mid+1,e,l,r);
